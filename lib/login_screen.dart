...
*/
    ...
    await db.execute('CREATE TABLE IF NOT EXISTS pedometer (id INTEGER PRIMARY KEY, steps TEXT default "0")');
    //await db.execute('drop table exercise');
    await db.execute(
        'CREATE TABLE IF NOT EXISTS exercise (id	INTEGER NOT NULL, name	TEXT NOT NULL, timer INTEGER, PRIMARY KEY(id, name, timer))');
    /*await db.execute(
    ...
    */
    ...
    await db.execute('INSERT OR IGNORE INTO pedometer(id) VALUES(1)');
